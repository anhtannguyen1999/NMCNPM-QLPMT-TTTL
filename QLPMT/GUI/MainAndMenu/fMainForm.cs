...
namespace GUI
{
    public partial class fMainForm : Form
    {
        ...
        {
            MessageBox.Show("Đồ án NMCNPM-Lớp SE104.J24 \nNhóm 15-TTTL \nGVHD: Cô Nguyễn Thị Thanh Trúc \nĐề tài: Phần mềm quản lý phòng mạch tư\nVersoin 1.0");
            
        }
       
        private void helpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://github.com/anhtannguyen1999/NMCNPM-QLPMT-TTTL");
            MessageBox.Show("Liên hệ nhân viên hỗ trợ:\nFB: http://fb.com/anhtannguyen1999 \nEmail: anhtannguyen1999@gmail.com\nHoặc đọc tài liệu hỗ trợ của chúng tôi tại github!");
